...
finalize_polish_prompt = """\
请对以下章节草稿进行定稿润色，重点修正叙事承接和场景切换，使它成为可以直接保存的章节正文。
...
润色要求：
- 保留原草稿的主要剧情、人物行动和信息量，不要另起新剧情。
- 章节开头必须自然承接前一章结尾的情绪、动作、地点或悬念。
- 场景切换要有明确过渡，交代时间、空间、人物视角或因果关系，避免突然跳切。
- 强化人物反应、环境细节和因果链，让上下文读起来连贯。
- 结尾要与下一章节目录信息形成合理铺垫，但不要提前写完下一章事件。
- 仅返回润色后的章节正文，不要解释、不要列提纲、不要添加额外标题。
