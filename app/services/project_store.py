...
class ProjectStore:
    ...
    def upsert_project(self, output_path: str | Path, title: str, genre: str) -> str:
        ...
        with self._connect() as connection:
            connection.execute(
                ...
                """,
                (project_id, normalized_path, title, genre, updated_at),
            )
        return project_id
    ...
    def get_project(self, project_id: str) -> dict[str, str] | None:
        with self._connect() as connection:
            row = connection.execute(
                """
                SELECT id, output_path, title, genre, updated_at
